                          ...
                          child: Padding(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  'You paid for the group. Now let\'s get you reimbursed.',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        font: GoogleFonts.inter(
                                ...
                                Text(
                                  'Final total calculated when splitting \$${_model.textController3.text}',
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                                        font: GoogleFonts.inter(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        Switch(
                                          ...
                                          activeTrackColor: Color(0xFF16A149),
                                          inactiveTrackColor:
                                              FlutterFlowTheme.of(context)
                                                  .secondaryText,
                                          inactiveThumbColor:
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    var stackRecordReference =
                                        StackRecord.collection.doc();
                                    await stackRecordReference
                                        .set(createStackRecordData(
                                      userID: currentUserUid,
                                      stackCreatorName:
                                          _model.textController1.text,
                                      stackFor: _model.textController2.text,
                                      amount: _model.totalAmount,
                                      includeCreator: _model.switchValue,
                                      currency: _model.dropDownValue,
                                      stackID: random_data.randomString(
                                        8,
                                        20,
                                        true,
                                        true,
                                    ...
                                    _model.createdStack =
                                        StackRecord.getDocumentFromData(
                                            ...
                                            stackRecordReference);
                                    FFAppState().ref =
                                        _model.createdStack?.reference;
                                    safeSetState(() {});
                                    if (_model.switchValue!) {
                                      await _model.createdStack!.reference
                                          .update({
                                        ...mapToFirestore(
                                          {
                                            'participants':
                                      ...
                                      FFAppState()
                                          .addToParticipants(ParticipantsStruct(
                                      ...
                                      FFAppState().participants = _model
                                          .createdStack!.participants
                                          .toList()
